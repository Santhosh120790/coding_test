...
public class GENx {
	...
	public double getEngineServiceLeft(double flightHours, int numRebuilds){

		int noOfbuildsLeft = maxNumRebuilds-numRebuilds;
		return 	(noOfbuildsLeft * flightHoursBeforeRebuild)+flightHours;
	}
